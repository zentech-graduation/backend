...
-- The audit type for sending a campaign. Safe in this migration because nothing here casts to
-- admin_action_type; the moderation_action_configs row naming it lives in V102, because PostgreSQL
-- does not make a new enum value usable until the adding transaction has committed.
