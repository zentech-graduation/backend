-- =============================================================================
-- V99__seed_feed_test_data.sql   DEV SEED — manual cleanup required before prod
--
...
-- GET /api/v1/posts/feed  authenticated as seed_viewer, no cursor param
-- Response: ApiResponse<CursorPageResponse<FeedPostResponse>>
--
-- data.items — 5 entries, newest-first:
--
--   [0]  id: 00000000-0000-0002-0000-000000000002
--        userId:  00000000-0000-0000-0000-000000000003  (seed_author2)
--        caption: "seed feed post A2-P2"
--        status:  published
--        createdAt: 2025-06-01T12:30:00Z
--
--   [1]  id: 00000000-0000-0001-0000-000000000003
--        userId:  00000000-0000-0000-0000-000000000002  (seed_author1)
--        caption: "seed feed post A1-P3"
--        status:  published
--        createdAt: 2025-06-01T11:00:00Z
--
--   [2]  id: 00000000-0000-0001-0000-000000000002
--        userId:  00000000-0000-0000-0000-000000000002  (seed_author1)
--        caption: "seed feed post A1-P2"
--        status:  published
--        createdAt: 2025-06-01T10:00:00Z
--
--   [3]  id: 00000000-0000-0001-0000-000000000001
--        userId:  00000000-0000-0000-0000-000000000002  (seed_author1)
--        caption: "seed feed post A1-P1"
--        status:  published
--        createdAt: 2025-06-01T09:00:00Z
--
--   [4]  id: 00000000-0000-0002-0000-000000000001
--        userId:  00000000-0000-0000-0000-000000000003  (seed_author2)
--        caption: "seed feed post A2-P1"
--        status:  published
--        createdAt: 2025-06-01T08:00:00Z
--
-- NOT in items:
--   00000000-0000-0001-0000-000000000004  A1-DRAFT    status=draft
--   00000000-0000-0002-0000-000000000003  A2-DELETED  status=removed (soft-deleted)
--   00000000-0000-0003-0000-000000000001  VIEWER-OWN  viewer.id not in authorIds (no self-follow)
--   00000000-0000-0004-0000-000000000001  PENDING     pending follow not in authorIds
--   00000000-0000-0005-0000-000000000001  VBLOCKS     viewer blocks vblocks → excluded from authorIds
--   00000000-0000-0006-0000-000000000001  BVIEWER     bviewer blocks viewer → excluded from authorIds
--   00000000-0000-0007-0000-000000000001  NOFOLLOW    not followed → not in authorIds
-- =============================================================================
