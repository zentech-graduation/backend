 ...
 * @param templateKey the sample it started from, or null
 * @param subject the mail subject
 * @param body the Markdown snapshot, which is the record of what was sent
 ...
 * @param recipients each recipient and their outcome
 */
public record MailCampaignDetailResponse(
        @Schema(description = "Campaign identifier") UUID id,
        @Schema(description = "Sample it started from", nullable = true) String templateKey,
        @Schema(description = "Mail subject") String subject,
        @Schema(description = "Markdown snapshot") String body,
        ...
        @Schema(description = "Recipients and their outcomes")
                List<MailCampaignRecipientResponse> recipients) {}
