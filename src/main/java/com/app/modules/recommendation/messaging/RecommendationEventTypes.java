 ...
 * impression batches carry up to {@code app.recommendation.events.max-batch-size} items
 * ({@link #REC_IMPRESSION_BATCH_V1}). Routing key equals the event type, matching every other
