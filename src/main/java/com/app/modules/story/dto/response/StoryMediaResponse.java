...
public record StoryMediaResponse(
        ...
        @Schema(description = "Pixel width, when known.", nullable = true) Integer width,
        @Schema(description = "Pixel height, when known.", nullable = true) Integer height,
        @Schema(description = "Video duration in seconds; null for images.", nullable = true)
                Integer duration,
        @Schema(description = "Blurhash placeholder string.", nullable = true) String blurhash) {}
