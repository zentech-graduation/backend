...
/**
 * Cached result of a comment write keyed by {@code (user_id, idempotency_key)}.
 *
 * <p>Maps to {@code comment_write_idempotency}. A retried create that reuses the same key and the
 ...
 */
@Entity
@Table(name = "comment_write_idempotency")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class CommentWriteIdempotency {
