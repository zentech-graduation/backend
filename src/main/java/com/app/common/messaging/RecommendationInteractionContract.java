 ...
 * each other.
 *
 * <p>Server-side engagement hooks enqueue {@link #REC_INTERACTION_RECORDED_V1} on the {@code
 * social.events} exchange with the recommendation interaction payload. The recommendation module's
 * {@code RecommendationEventTypes} mirrors these values for the consumer side.
 */
