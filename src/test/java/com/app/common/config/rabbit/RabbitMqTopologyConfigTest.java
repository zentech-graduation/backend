    ...
    void topology_contextLoads_doesNotBindFutureQueues() {
        contextRunner.run(
                context -> {
                    ...
                    // comment.notification, story.notification, message.notification, and
                    // admin.notification dead-letter bindings plus the comment live, message live,
                    // notification live, and post live exchange-to-exchange bindings.
                    assertThat(context.getBeansOfType(Binding.class)).hasSize(12);
                });
    }
