...
### Security
- Public user-profile lookups now enforce block and private-account visibility: a block in either direction returns 404, and follower/following/post counts are hidden from non-followers of a private account while remaining visible to the owner and accepted followers.
