...
### Security
- Post captions (create and update) and user bio are now length-bounded at the request layer (2200 and 500 characters respectively), preventing unbounded text from being persisted to the database.
