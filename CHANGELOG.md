...
### Security
- Post search now caps the requested page size at 100, preventing an authenticated caller from forcing an oversized multi-table result hydration or a server error by requesting a very large limit.
