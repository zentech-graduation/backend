...
### Security
- Comment replies whose parent belongs to a different post are now rejected, closing a cross-post injection that bypassed the target post's commenting restrictions and corrupted reply counts.
